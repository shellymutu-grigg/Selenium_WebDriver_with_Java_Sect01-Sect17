...
public class Section04Code {
	...
	public static void main(String[] args) {
		...
		// String Literals - String is an Object that represents a sequence of
		// characters
		String first = "First string";
		String second = "First string"; // This will create a reference to "first" rather than create new object in
										// memory
